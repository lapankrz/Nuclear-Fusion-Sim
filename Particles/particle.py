...
class Particle:
    ...
    def get_influence_from(self, particle):
        ...
        if dist > 0:
            ...
            additional_velocity = acc * -self.get_vector_to(particle) * proportion_constant
    ...
    def gravity_influence(self,dt):
        force = self.mass_kg * gravity
        acceleration = force / self.mass_kg
